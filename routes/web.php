...
Route::get('/gallery/{id}/edit', [EventController::class, 'galeryedit'])->name('gallery.edit');
Route::put('/gallery/{id}', [EventController::class, 'galeryupdate'])->name('gallery.update');
