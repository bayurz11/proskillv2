@if (Route::is(['accounts']))
    ...
    <div class="modal fade custom-modal" id="payment_request_modal" role="dialog">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control form-white select" data-placeholder="Choose a color..."
                                name="category-color">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>This <a class="btn btn-primary popover-test" href="javascript:;" role="button" title=""
                    ...
                    <p><a class="tooltip-test" href="javascript:;" title="" data-container="#exampleModalPopovers"
                            data-bs-original-title="Tooltip">This link</a> and <a class="tooltip-test" href="javascript:;"
                ...
                <form action="#" enctype="multipart/form-data" autocomplete="off" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control select" name="gender">
            ...
            <div class="modal-content">
                <form action="#" enctype="multipart/form-data" autocomplete="off" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="control-label mb-10">DOB </label>
                            <input type="text" name="dob" id="editdob" value="01/12/2023" readonly=""
                                class="form-control">
                        </div>
                        <div class="mb-3">
                            <label class="control-label mb-10">Photo </label>
...
@if (Route::is(['medical-details']))
    <!-- Add Medical Detail -->
    <div id="modal_medical_form" class="modal fade custom-modal" tabindex="-1" role="dialog"
        style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="#" enctype="multipart/form-data" autocomplete="off" method="post">
    ...
    <!-- Edit Medical Detail -->
    <div id="edit_medical_form" class="modal fade custom-modal" tabindex="-1" role="dialog"
        style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="#" enctype="multipart/form-data" autocomplete="off" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="control-label mb-10">Created Date </label>
                            <input type="text" name="dob" id="editdob" value="11/11/2023" readonly=""
                                class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer text-center">
                                    ...
                                    <div class="upload-medical-records">
                                        ...
                                        <div class="upload-content dropzone">
                                            <div class="text-center">
                                                <div class="upload-icon mb-2"><img
                                                        src="{{ URL::asset('/assets/img/upload-icon.png') }}"
                                                        alt=""></div>
                                                <h5>Drag &amp; Drop</h5>
...
@if (Route::is(['patient-accounts']))
    <!-- Account Details Modal -->
    <div class="modal fade custom-modal" id="account_modal" role="dialog" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="payment_request_form" method="post">
                        ...
                        <div class="mb-3">
                            <label>Request Amount</label>
                            <input type="text" onkeyup="amount()" onblur="amount()" name="request_amount"
                                id="request_amount" class="form-control" maxlength="6"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                            <span class="help-block"></span>
                        </div>
                        <div class="mb-3">
