...
@section('content')
                ...
                <div class="marquee-inner to-left">
                    <ul class="marqee-list d-flex">
                        <li class="marquee-item">
                            ...
                            <span class="text-slider"><img src="public/assets/img/ChatGPT.svg"
                                    alt="img"></span><span class="text-slider">ChatGPT</span>
    ...
    <section class="event-section section-padding bg-cover"
        ...
        <div class="container">
            <div class="section-title text-center">
                <span class="text-white wow fadeInUp">Our events</span>
                <h2 class="text-white wow fadeInUp" data-wow-delay=".3s">Upcoming school activities & <br> events
                    schedule</h2>
            </div>
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="event-box-items">
                        <div class="event-image">
                            <img src="public/assets/img/event/01.jpg" alt="event-img">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="event-box-items">
                        <div class="event-image">
                            <img src="public/assets/img/event/02.jpg" alt="event-img">
                            <div class="event-shape">
                                <img src="public/assets/img/event/shape.png" alt="shape-img">
                            </div>
                            <ul class="post-date">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                    <div class="event-box-items">
                        <div class="event-image">
                            <img src="public/assets/img/event/03.jpg" alt="event-img">
                            <div class="event-shape">
                                <img src="public/assets/img/event/shape.png" alt="shape-img">
                            </div>
                            <ul class="post-date">
            ...
            <div class="news-wrapper">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="news-right-items style-2">
                            <div class="news-thumb">
                                <img src="public/assets/img/news/07.jpg" alt="img">
                            </div>
                            <div class="news-content">
                                <ul>
                                    <li>
                                ...
                                <div class="post-items">
                                    <div class="thumb">
                                        <img src="public/assets/img/news/author-3.png" alt="img">
                                    </div>
                                    <div class="content">
                                        <span>By Admin</span>
    ...
    <div class="popup" id="popup"
        ...
        <img src="public/assets/img/Whatsapp.png" alt="WhatsApp Logo"
            style="position: absolute; top: 5px; right: 5px; width: 20px; height: 20px; cursor: pointer;"
            onclick="document.getElementById('popup').style.display = 'none';">
        <p>Butuh bantuan? <a href="https://wa.me/+6281266187125" target="_blank"></a></p>
    </div>
