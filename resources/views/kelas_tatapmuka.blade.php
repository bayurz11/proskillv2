        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="blog">
                    <div class="blog-image">
                        <a href="{{ route('blog-details', ['id' => $article->id]) }}">
                            <img class="img-fluid" src="{{ asset('public/uploads/' . $article->banner) }}" alt="Gambar" width="1200" height="800">
                        </a>

                    </div>
                    <h3 class="blog-title"><a href="{{ route('blog-details', ['id' => $article->id]) }}">{{ $article->title }}</a>
                    </h3>
                            ...
                            <ul>
                                <li>
                                    <div class="post-author">
                                        <span><i class="far fa-user" style="color: #028E83;"></i>{{ $article->user->name }}</span>
                                    </div>
                                </li>
                                ...
                                <li><i class="fa fa-tags" style="color: #028E83;"></i>
                                    ...
                                    @if (is_array($tags))
                                    @foreach ($tags as $tag)
                                    <span class="badge" style="background-color: #028E83; color: white; font-size: 12px;">
                                        {{ $tag['value'] }}
                                    </span>
                                    @endforeach
                                    @endif
                ...
                <div class="blog">
                    <div class="blog-image">
                        <div class="video">
                            <iframe src="https://www.youtube.com/embed/{{ $link->isiyt }}?rel=0&amp;controls=0&amp;showinfo=0" width="940" allowfullscreen></iframe>
                        </div>
                            ...
                            <ul>
                                <li>
                                    <div class="post-author">
                                        ...
                                        <span><i class="far fa-user" style="color: #028E83;"></i>{{ $link->user->name }}</span>
                                    </div>
                                </li>
                        ...
                        <ul class="latest-posts">
                            ...
                            <li>
                                <div class="post-thumb">
                                    <a href={{ route('blog-details', ['id' => $article->id]) }}>
                                        <img class="img-fluid" src="{{ asset('public/uploads/' . $article->banner) }}" alt="blog-image">
                                    </a>
                                </div>
                                <div class="post-info">
                                    <h4>
...
<!-- Whatsapp popup -->
<div id="whatsapp-popup" style="display: none; position: fixed; bottom: 20px; right: 20px; z-index: 9999; cursor: move;" ontouchstart="handleTouchStart(event)" ontouchmove="handleTouchMove(event)">
    <a href="https://wa.me/6281266187125?" target="_blank">
        <img src="public/assets/img/whatsapp.png" alt="WhatsApp Icon" style="width: 50px; height: auto;">
    </a>
    <div id="popup-message" style="display: none; position: absolute; top: -40px; left: -160px; background-color: #fff; padding: 10px; border: 1px solid #ccc;">
