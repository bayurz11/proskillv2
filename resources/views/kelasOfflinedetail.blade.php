@section('title', 'ProSkill Akademia | Kelas Tatap Muka Detail')
    ...
    <div class="breadcrumb-wrapper bg-cover"
        ...
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Kelas Tatap Muka Detail</h1>
                    ...
                    <div class="blog-post-details">
                        <div class="single-blog-post">
                            <div class="post-featured-thumb bg-cover"
                                style="background-image: url('{{ asset('public/uploads/' . $offline->banner) }}');"  loading="lazy">
                            </div>
